view the original on <a href=https://adventofcode.com/2022/day/2>adventofcode.com</a>
<h2>--- Day 2: Rock Paper Scissors ---</h2><p>The Elves begin to set up camp on the beach. To decide whose tent gets to be closest to the snack storage, a giant <a href="https://en.wikipedia.org/wiki/Rock_paper_scissors">Rock Paper Scissors</a> tournament is already in progress.</p>
